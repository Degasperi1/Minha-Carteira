...
// ==> Rota responsável por selecionar 'Movement' pelo 'Type' e periodo: (GET): localhost:3000/api/movements/type/:id:dtIni:dtFim
router.get('/movements/type/:id/:dtIni/:dtFim', movementController.findMovementByTypeDate);
